...
-- restore
ETCDCTL_API=3 etcdctl snapshot restore bb2.db --endpoints=https://<ipmastera>:2379 --cacert=/etc/kubernetes/pki/etcd/ca.crt --cert=/etc/kubernetes/pki/etcd/server.crt --key=/etc/kubernetes/pki/etcd/server.key --data-dir=/var/lib/etcd
